...
module UI
  ...
  BUTTON_PRIMARY = 'rounded-lg py-3 px-5 bg-blue-600 text-white block font-medium'
  BUTTON_SECONDARY = 'ml-2 rounded-lg py-3 px-5 bg-gray-100 inline-block font-medium'
