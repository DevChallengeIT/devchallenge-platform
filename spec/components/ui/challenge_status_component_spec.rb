...
RSpec.describe UI::ChallengeStatusComponent, type: :component do
  ...
  it 'renders moderation staus' do
    ...
    expect(rendered_component).to have_css "span[class='rounded font-semibold px-3 py-2 text-white bg-orange-500']",
                                           text: 'moderation'
  end
  ...
  it 'renders canceled staus' do
    ...
    expect(rendered_component).to have_css "span[class='rounded font-semibold px-3 py-2 text-white bg-red-500']",
                                           text: 'canceled'
  end
end
