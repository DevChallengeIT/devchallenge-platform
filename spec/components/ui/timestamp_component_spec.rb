...
RSpec.describe UI::TimestampComponent, type: :component do
  it 'renders formatted timestamp value' do
    ...
    expect(page).to have_css "span[class='rounded font-semibold bg-white']",
  ...
  it 'renders formatted timestamp value with highlight_now in the past' do
    ...
    expect(page).to have_css "span[class='rounded font-semibold bg-green-100 text-green-800']"
  end
  ...
  it 'renders formatted timestamp value with highlight_now in the future' do
    ...
    expect(page).to have_css "span[class='rounded font-semibold bg-gray-100 text-gray-800']"
  end
